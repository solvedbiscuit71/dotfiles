...
require('lazy').setup({
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'isort', -- Used to order Python import statement
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      -- To enable format_on_save, uncomment the below lines
      -- format_on_save = {
      --   timeout_ms = 500,
      --   lsp_format = 'fallback',
      -- },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- New operators such as evaluate, exchange, multiply, replace, sort
      ...
      -- Automatic brackets/quotes pairs
